...
public class MillionFlaxRedWLAWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(MillionFlaxRedWLAWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/MillionFlaxRedWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/MillionFlaxRedWLAIW/InitOutcome.xml").getDocumentElement();
